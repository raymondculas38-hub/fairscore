...
<head>
    ...
    <title>@yield('title', 'FairScore') — Admin</title>
    ...
    <div class="px-3 pb-4 border-t pt-4" style="border-color:rgba(255,255,255,0.06);">
        <div class="flex items-center gap-3 px-2">
            ...
            <div class="flex-1 min-w-0">
                <div class="text-sm font-semibold truncate" style="color:#e2e8f0;">{{ auth()->user()->name }}</div>
...
<main class="flex-1 flex flex-col h-full overflow-hidden">
    ...
    <header class="flex items-center justify-between px-6 py-4 flex-shrink-0 border-b" style="background:#07101f;border-color:rgba(255,255,255,0.06);">
        <div>
            <h1 class="text-lg font-bold" style="color:#f1f5f9;">@yield('page-title', 'Dashboard')</h1>
            <p class="text-xs mt-0.5" style="color:#475569;">@yield('page-subtitle', '')</p>
        </div>
