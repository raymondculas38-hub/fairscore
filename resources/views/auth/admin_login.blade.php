        ...
        <div class="space-y-4">
            <div>
                <label for="admin-username" class="form-label">Username</label>
                    <input type="text" id="admin-username" name="username" value="{{ old('username') }}" autocomplete="username" placeholder="Enter admin username" required autofocus class="form-input">
                </div>
                <div>
        ...
        <div class="mt-6 text-center">
            ...
            <div class="mt-6 pt-5 border-t border-white/5 text-center">
                <p class="text-sm text-slate-400 mb-0">
                    ...
                    <a href="{{ route('admin.register') }}" class="text-amber-500 hover:text-amber-400 font-bold underline transition-colors">Create account</a>
                </p>
            </div>
        </div>
    </div>
