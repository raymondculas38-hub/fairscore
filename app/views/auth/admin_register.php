...
<div class="w-full max-w-md animate-fade-in-up">
    ...
    <div class="glass-card p-8 overflow-hidden relative">
        ...
        <form method="POST" action="<?= htmlspecialchars((string)(route('admin.register.post'))) ?>" id="register-form">
            <?= csrf_field() ?>
            ...
            <div id="step-1" class="step-transition active-step w-full">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="<?= htmlspecialchars((string)(old('name'))) ?>" required autofocus class="form-input">
                    </div>
                    <div>
                        <label for="address" class="form-label">Address</label>
                        <input type="text" id="address" name="address" value="<?= htmlspecialchars((string)(old('address'))) ?>" required class="form-input">
                    </div>
                </div>
            ...
            <div id="step-2" class="step-transition hidden-step w-full">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="username" name="username" value="<?= htmlspecialchars((string)(old('username'))) ?>" required class="form-input">
                    </div>
        ...
        <div class="mt-6 pt-5 border-t border-white/5 text-center">
            <p class="text-sm text-slate-400">
                ...
                <a href="<?= htmlspecialchars((string)(route('admin.login'))) ?>" class="text-amber-500 hover:text-amber-400 font-bold underline transition-colors">Sign in here</a>
            </p>
        </div>
    </div>
</div>
