        ...
        <div class="space-y-4">
            <div>
                <label for="judge-username" class="form-label">Username</label>
                    <input type="text" id="judge-username" name="username" value="<?= htmlspecialchars((string)(old('username'))) ?>" autocomplete="username" placeholder="Enter judge username" required autofocus class="form-input focus:border-indigo-500 focus:ring-indigo-500/20">
                </div>
                <div>
